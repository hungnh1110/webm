                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-8">
                                        <div class="banner_text">
                                            <div class="banner_text_iner" style="padding-left:30px">
                                                <h2 class="addfont" style="text-transform: none;"><?= $item['ten'] ?></h2>
                                                <p><?= $item['mota'] ?></p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="subscribe_area_text text-center">
                        <h5>THAM GIA CHƯƠNG TRÌNH CỦA CHÚNG TÔI</h5>
                        <h2>Đăng ký để nhận được các ưu đãi mới nhất</h2>
