                ...
                <div class="login_part_form">
                    ...
                    <div class="login_part_form_iner">
                                    ...
                                    if ($sdt != "") {
                                        if ($matkhau != "") {
                                            if ($matkhau !== $nlmatkhau) {
                                                $error = 'Mật khẩu nhập lại không chính xác!';
                                            } else {
                        ...
                        <form class="row contact_form" action="" method="post" novalidate="novalidate">
                            ...
                            if (isset($error)) {
                            ?>
                            <p class="text-danger ml-3 mb-3" style=" text-align: center;"><?= $error ?></p>
                            <?php
                            }
                                if (isset($success)) {
                            ?>
                            <p class="text-success ml-3 mb-3"><?= $success ?></p>
                            <?php
                            }
                            ?>

                            <div class="col-md-12 form-group p_star">
                                <input type="text" name="ten" class="form-control" required autofocus value="" placeholder="Họ Tên" required>
                            </div>
                            <div class="col-md-12 form-group p_star">
                                <input type="email" class="form-control" name="email" value="" placeholder="Email" required>
                            </div>
                            <div class="col-md-12 form-group p_star">
                                <input type="text" class="form-control" name="sdt" value="" placeholder="Số điện thoại" required>
                            </div>
                            <div class="col-md-12 form-group p_star">
